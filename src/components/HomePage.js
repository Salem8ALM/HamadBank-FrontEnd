...
function HomePage() {
  return (
    <>
      {/* Home Card */}
      <div className="grid bg-white w-[70rem] grid-cols-2 rounded-lg m-auto mt-16 overflow-hidden">
        <div>
          <Image
            width={570}
            height={300}
        ...
        <div className="text-[#54585a] flex flex-col items-center justify-center text-left">
          <div className="">
            ...
            <Link href="/login">
              <button className="mx-5 border-[#b39521] text-[#b39521] border-[1px] rounded-md p-6 py-2 hover:scale-110 hover:bg-[#b39521] hover:text-white hover:shadow-[0_8px_16px_0_rgba(207,214,112,016)] duration-300">
                Bank with us today
              </button>
            </Link>
          </div>
